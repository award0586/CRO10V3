...
#define STRING_CONFIG_H_AUTHOR "Aaron Ward, CR10-V3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CR10-V3 SKR13"
...
#define X_BED_SIZE 305  // Nozzle is at X0 when homed
#define Y_BED_SIZE 305 // Nozzle is at Y0 when homed
...
#define HOMING_FEEDRATE_Z  (4*60) // FP
...
// https://reprap.org/wiki/RepRapDiscount_Smart_Contro01ller
//
